...
public class ImagesBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "id.govca.recyclerviewapi.TOAST_ACTION";
    public static final String EXTRA_ITEM = "id.govca.recyclerviewapi.EXTRA_ITEM";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
        PendingIntent toastPendingIntent = PendingIntent.getBroadcast(context, 50, toastIntent, PendingIntent.FLAG_UPDATE_CURRENT);
